...
import com.example.mhike.MainActivity;
import com.example.mhike.ObservationActivity;
import com.example.mhike.R;
import com.example.mhike.db.entity.Hike;
...
public class HikeAdapter extends RecyclerView.Adapter<HikeAdapter.HikeViewHolder> {
    ...
    public void onBindViewHolder(@NonNull HikeAdapter.HikeViewHolder holder, @SuppressLint("RecyclerView") int positions) {
        ...
        ImageButton deleteButton = holder.itemView.findViewById(R.id.deleteButton);
        deleteButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mainActivity.deleteHike(hike, positions);
            }
        });
